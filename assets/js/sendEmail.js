function sendMail(contact) {
    emailjs.send("gmail", "template_0BsHojmu", {
        ...
        .then(
            function (response) {
                ...
                setTimeout("window.location.href = 'Thank_you.html';", 250); // the user will know that their message was sent successfully and is given feedback.
